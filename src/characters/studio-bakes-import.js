...
// Latest Face Studio correction export. Portrait ids lose their generated "gen-" prefix here
// because the bake map is keyed by the underlying character seed id.
(function applyJulyFaceStudioExport() {
  const latest = {
    "aaron": {
      "tattooScale": 0.95,
      "tattoos": [
        ...
        "layers": [
          {
            ...
            "line": null,
            "internalLine": false,
            "internalLineWidth": null,
            "internalLineColor": null
          },
          {
            "id": "placed:lock:cheekCurl:3",
            "piece": "lock:cheekCurl",
            "origin": "placed",
            "preset": null,
            "zone": "front",
            "x": 65,
          ...
          {
            "id": "placed:lock:curlyForelock:5",
            "piece": "lock:curlyForelock",
            "origin": "placed",
            "preset": null,
            "zone": "front",
            "x": 39,
          ...
          {
            "id": "placed:lock:longSideLock:4",
            "piece": "lock:longSideLock",
            "origin": "placed",
            "preset": null,
            "zone": "behind",
            "x": 33,
