(function () {
  ...
  const groupOrder = ["Structure", "Skin", "Lighting", "Hair", "Brows", "Eyes", "Nose", "Face Lines", "Cheeks", "Mouth", "Teeth", "Clothing", "Accessory", "Jewellery", "Beard", "Animation", "Moustache", "Tattoo"];
  const groupTitleMap = {
