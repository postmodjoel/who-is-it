...
function renderEditorControls() {
  ...
  const shadowRows = castShadowList(t).map((item, i) => `
    <div class="ed-lockrow ed-tatrow">
      ...
      ${field("Surface", `<select data-key="__shadow:${i}:surface"><option value="face" ${(item.surface || "face") === "face" ? "selected" : ""}>Face</option><option value="neck" ${(item.surface || "face") === "neck" ? "selected" : ""}>Neck</option><option value="body" ${(item.surface || "face") === "body" ? "selected" : ""}>Body / Clothes</option><option value="both" ${(item.surface || "face") === "both" ? "selected" : ""}>Face + Neck</option><option value="all" ${(item.surface || "face") === "all" ? "selected" : ""}>Face + Neck + Body</option></select>`)}
